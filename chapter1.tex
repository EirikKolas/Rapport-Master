...
This thesis builds upon \citet{Thyri2022MPC} and \citet{zhang2021real}, combining optimal control, B-splines, and mixed-integer programming for COLREGS-aware trajectory planning. Mixed-integer programming ensures COLREGS compliance, while B-splines offer trajectory smoothness and constraint satisfaction. The algorithm aims for robustness and real-time capability in dynamic environments.

...
\includesvg[width=\textwidth,pretex=\footnotesize]{fig/scenarios/crossing_advanced/crossing_advanced_scenario_10_2.svg}
    \caption{\emph{Case 3.1}: Trajectory generation in a crossing situation with a more complex reference trajectory.}
    \label{fig:crossing-advanced}
\end{figure}
...
\begin{figure}
    ...
    \caption{\emph{Case 3.2}: Trajectory generation in a crossing situation with a more complex reference trajectory and a 10\degree course change.}
    \label{fig:crossing-advanced-course-10}
\end{figure}
...
\begin{figure}
    ...
    \caption{\emph{Case 3.2}: Trajectory generation in a crossing situation with a more complex reference trajectory and a 20\degree course change.}
\end{figure}

...
\end{equation*}
or if $u(x)$ and $v(x)$ are both constant.  B-Splines are piecewise polynomials and can only approximate sines and cosines, not represent them exactly.  This explains the small dips in speed during the course change segments, as well as why the speed is able to be kept exactly constant during the straight line segments of the trajectory.

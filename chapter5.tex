...
\includesvg[width=\textwidth,pretex=\footnotesize]{fig/scenarios/crossing_advanced/crossing_advanced_scenario_10_2.svg}
    \caption{\emph{Case 3.0}: Trajectory generation in a crossing situation where the TS has a course, from top to bottom, of -70\degree, -40\degree, 20\degree, and 40\degree with respect to the North axis.}
    \label{fig:crossing}
\end{figure}
...
\begin{figure}
    ...
    \caption{\emph{Case 3.0}: Speed, change in course, and distance to the reference trajectory for the OSs in \cref{fig:crossing} in the 40\degree course case.}
...
\begin{figure}
    ...
    \caption{\emph{Case 3.1}: Speed, change in course, and distance to the reference trajectory for the OSs in \cref{fig:crossing} in the 40\degree course case, where the OS spline $\mathbf p_\text{OS}$ is represented in a finer basis.}
\end{figure}

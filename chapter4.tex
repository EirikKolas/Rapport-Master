...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includesvg[width=\textwidth]{fig/conservativeness/eigenvectors_integral_degree_2_N_3.svg}
        \caption{$\mathbf H = \mathbf G$}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includesvg[width=\textwidth]{fig/conservativeness/eigenvectors_coeffs_degree_2_N_3.svg}
        \caption{$\mathbf H = \mathbb{I}$}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includesvg[width=\textwidth]{fig/conservativeness/eigenvectors_inv_gramian_degree_2_N_3.svg}
